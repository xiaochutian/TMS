...
public interface JobManager{
     ...
     */
    List<JobBean> getJobs(int start, int len);
     ...
     */
    List<JobBean> getJobs(UserBean userBean);
     ...
     */
    void removeJob(JobBean jobBean);
     ...
     */
    List<TrainBean> getTrains(JobBean jobBean);
     ...
     */
    void checkTrain(TrainBean trainBean, boolean accept);
}
